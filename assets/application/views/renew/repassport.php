                            ...
                            <div class="form-group">
                                ...
                                <select id="type_travel" name="type_travel" class="form-control">
                                    <option value="PASSPORT"
                                        <?= $passport['type_travel'] == 'PASSPORT' || set_value('type_travel') == 'PASSPORT' ? 'selected' : '' ?>>
                                        PASSPORT
                                    </option>
                                    <option value="RESTRICTED TRAVEL DOCUMENT"
                                        <?= $passport['type_travel'] == 'RESTRICTED TRAVEL DOCUMENT' || set_value('type_travel') == 'RESTRICTED TRAVEL DOCUMENT' ? 'selected' : '' ?>>
