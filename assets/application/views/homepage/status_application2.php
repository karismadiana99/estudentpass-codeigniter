        ...
        <div class="col-md-8 mx-auto mb-4">
            <div class="card shadow">
                <div class="card-body mx-4">
                    ...
                    <h2 class="m-0 font-weight-bold text-primary mb-4">Status of Application</h2>
                    <hr>
                    <br>
                    <form action="" method="POST" autocomplete="off">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                <label class="d-block font-weight-bold">IC Number</label>
                        ...
                        <div class="text-center" href="<?= base_url('Apply/digitalPass') ?>">
                            <a href="<?= base_url('apply/digitalPass') ?>" class="btn btn-success"><span><i
                                        class="bi bi-plus-circle-fill"></i>
                                    &nbsp;&nbsp;</span>
                                View Digital Student Pass</a>
                        </div>
                    </form>
                    <br>
                </div>
